...
// START BLINK SECTION FOR TESTING TO ENSURE ITS ON
...
// END BLINK SECTION FOR TESTING TO ENSURE ITS ON
...
int main() {
    ...
    if(IDENTIFY_HALLS_ON_BOOT) identify_halls();
